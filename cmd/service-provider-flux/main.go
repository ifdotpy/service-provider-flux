...
func initOnboardingScheme() {
	...
	utilruntime.Must(fluxsv1alpha1.AddToScheme(onboardingScheme))
}
...
func main() {
	...
	car := advanced.NewClusterAccessReconciler(platformCluster.Client(), "Flux").
